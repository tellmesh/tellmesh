...
```bash
uv run python -m generator.agent_generator contracts/agents/user_agent.yaml
```
...
generator:
  ...
  command: uv run python -m generator.agent_generator contracts/agents/user_agent.yaml
runtime:
