...
```bash
uv run python -m generator.agent_generator contracts/agents/codex_nl_smoke_agent.yaml
```
...
generator:
  ...
  command: uv run python -m generator.agent_generator contracts/agents/codex_nl_smoke_agent.yaml
runtime:
