...
Six cards on [`tellmesh/www/index.html`](../www/index.html) map to canonical scenarios in
...
- Click a card → `localStorage.taskinity.chatPrompt` → [`tellmesh/www/chat.html`](../www/chat.html)
