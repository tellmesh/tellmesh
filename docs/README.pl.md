...
Źródło UI: [`tellmesh/www`](../www). Po `make start` lub `urish www serve` (`http://localhost:8788`):
...
- [`tellmesh/www/docs/examples.html`](../www/docs/examples.html) — **docs WWW** (README + YAML/SH z examples)
- [`tellmesh/www/przyklady.html`](../www/przyklady.html) — lab integracji na WWW
