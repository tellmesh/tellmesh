...
Static UI source: [`tellmesh/www`](../www). After `make start` or `urish www serve` (`http://localhost:8788`):
...
- [`tellmesh/www/docs/examples.html`](../www/docs/examples.html) — **WWW docs** (README + YAML/SH from examples)
- [`tellmesh/www/przyklady.html`](../www/przyklady.html) — integration lab on WWW
