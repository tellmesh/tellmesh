...
**WWW documentation (full content):** [`tellmesh/www/docs/examples.html`](../www/docs/examples.html) — all READMEs + YAML/TXT/SH files · [`tellmesh/www/przyklady.html`](../www/przyklady.html) — PASS lab + commands.
...
Built into [`tellmesh/www/index.html`](../www/index.html) `#integracje` by `scripts/www/build_landing_integrations.py`.
...
| 39 | [`39_system_automations`](./39_system_automations/) | **System automations: env, apt, browser, desktop (kvm/him/ocr/llm/rdp)** | `bash examples/39_system_automations/run.sh` |
